        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    var db = new FootWearDb();
                    db.webpages_UsersInRoles.Add(new webpages_UsersInRoles { RoleId = 2, UserId = WebSecurity.GetUserId(User.Identity.Name) });
                    db.SaveChanges();
                    db.PersonInfoes.Add(new PersonInfo { UserId = WebSecurity.GetUserId(User.Identity.Name), FirstName = model.UserName });
                    db.SaveChanges();
                    return RedirectToAction("Index", "Home");
                }
